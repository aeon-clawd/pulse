// ISO 3166-1 numeric to alpha-2 mapping for world-atlas topojson
...
const ISO_NUMERIC_TO_ALPHA2 = {
  ...
  '578':'NO','512':'OM','586':'PK','585':'PW','591':'PA','598':'PG','600':'PY',
  ...
  '840':'US','858':'UY','860':'UZ','548':'VU','336':'VA','862':'VE','704':'VN',
  '887':'YE','894':'ZM','716':'ZW',
  // Territories often in world-atlas
  '-99':'CY','10':'AQ','074':'BV','162':'CX','166':'CC','184':'CK',
  '238':'FK','254':'GF','258':'PF','260':'TF','304':'GL','312':'GP',
  '474':'MQ','175':'YT','540':'NC','570':'NU','574':'NF','580':'MP',
  '612':'PN','638':'RE','654':'SH','666':'PM','652':'BL','663':'MF',
  '796':'TC','876':'WF','732':'EH',
};

export default ISO_NUMERIC_TO_ALPHA2;
